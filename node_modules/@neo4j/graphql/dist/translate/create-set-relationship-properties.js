...
*/
function createSetRelationshipProperties({ properties, varName, relationship, operation, callbackBucket, parameterPrefix, }) {
    const strs = [];
    ...
    relationship.primitiveFields.forEach((field) => (0, callback_utils_1.addCallbackAndSetParam)(field, varName, properties, callbackBucket, strs));
