...
function updateResolver({ node, schemaComposer }) {
    async function resolve(_root, args, _context, info) {
        ...
        (0, publish_events_to_plugin_1.publishEventsToPlugin)(executeResult, (_a = context.plugins) === null || _a === void 0 ? void 0 : _a.subscriptions);
        const nodeProjection = (_b = info.fieldNodes[0].selectionSet) === null || _b === void 0 ? void 0 : _b.selections.find((selection) => selection.kind === "Field" && selection.name.value === node.plural);
        const nodeKey = (nodeProjection === null || nodeProjection === void 0 ? void 0 : nodeProjection.alias) ? nodeProjection.alias.value : (_c = nodeProjection === null || nodeProjection === void 0 ? void 0 : nodeProjection.name) === null || _c === void 0 ? void 0 : _c.value;
        return {
            info: {
                bookmark: executeResult.bookmark,
                ...executeResult.statistics,
            },
            ...(nodeProjection ? { [nodeKey]: ((_d = executeResult.records[0]) === null || _d === void 0 ? void 0 : _d.data) || [] } : {}),
        };
    }
