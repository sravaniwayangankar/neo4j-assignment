...
const wrapResolver = ({ driver, config, nodes, relationships, schema, plugins }) => (next) => async (root, args, context, info) => {
    ...
    context.subscriptionsEnabled = Boolean((_a = context.plugins) === null || _a === void 0 ? void 0 : _a.subscriptions);
    context.callbacks = config.callbacks;
    if (!context.jwt) {
        if ((_b = context.plugins) === null || _b === void 0 ? void 0 : _b.auth) {
...
const wrapSubscription = (resolverArgs) => (next) => (root, args, context, info) => {
    var _a;
    // TODO: context auth
    let subscriptionContext = {};
    if ((_a = resolverArgs.plugins) === null || _a === void 0 ? void 0 : _a.subscriptions) {
        subscriptionContext = {
