...
const Scalars = __importStar(require("./types/scalars"));
...
const ensureNonEmptyInput_1 = require("./ensureNonEmptyInput");
...
const CreateInfo_1 = require("./types/objects/CreateInfo");
const DeleteInfo_1 = require("./types/objects/DeleteInfo");
const UpdateInfo_1 = require("./types/objects/UpdateInfo");
const PageInfo_1 = require("./types/objects/PageInfo");
const SortDirection_1 = require("./types/enums/SortDirection");
const QueryOptions_1 = require("./types/input-objects/QueryOptions");
const Point_1 = require("./types/objects/Point");
const CartesianPoint_1 = require("./types/objects/CartesianPoint");
const PointInput_1 = require("./types/input-objects/PointInput");
const CartesianPointInput_1 = require("./types/input-objects/CartesianPointInput");
const PointDistance_1 = require("./types/input-objects/PointDistance");
const CartesianPointDistance_1 = require("./types/input-objects/CartesianPointDistance");
...
function makeAugmentedSchema(typeDefs, { enableRegex, skipValidateTypeDefs, generateSubscriptions, callbacks, } = {}) {
    ...
    interfaceRelationships.forEach((interfaceRelationship) => {
        const implementations = objectTypes.filter((n) => { var _a; return (_a = n.interfaces) === null || _a === void 0 ? void 0 : _a.some((i) => i.name.value === interfaceRelationship.name.value); });
        ...
        (0, ensureNonEmptyInput_1.ensureNonEmptyInput)(composer, `${interfaceRelationship.name.value}CreateInput`);
        (0, ensureNonEmptyInput_1.ensureNonEmptyInput)(composer, `${interfaceRelationship.name.value}UpdateInput`);
        [
        ...
        ].forEach((c) => (0, ensureNonEmptyInput_1.ensureNonEmptyInput)(composer, c));
    });
    if (pointInTypeDefs) {
    ...
    nodes.forEach((node) => {
        ...
        (0, ensureNonEmptyInput_1.ensureNonEmptyInput)(composer, `${node.name}UpdateInput`);
        (0, ensureNonEmptyInput_1.ensureNonEmptyInput)(composer, `${node.name}CreateInput`);
        ...
        if (!((_a = node.exclude) === null || _a === void 0 ? void 0 : _a.operations.includes("read"))) {
            ...
            composer.Query.addFields({
                [`${node.plural}Connection`]: (0, resolvers_1.rootConnectionResolver)({ node, composer }),
            });
        }
    ...
    const emptyObjectsInterfaces = parsedDoc.definitions.filter((x) => (x.kind === "ObjectTypeDefinition" && !(0, is_root_type_1.isRootType)(x)) || x.kind === "InterfaceTypeDefinition").filter((x) => { var _a; return !((_a = x.fields) === null || _a === void 0 ? void 0 : _a.length); });
