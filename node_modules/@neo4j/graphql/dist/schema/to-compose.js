...
function objectFieldsToCreateInputFields(fields) {
    return fields
        .filter((f) => !(f === null || f === void 0 ? void 0 : f.autogenerate) && !(f === null || f === void 0 ? void 0 : f.timestamps))
        .reduce((res, f) => {
        const fieldType = f.typeMeta.input.create.pretty;
        const defaultValue = f === null || f === void 0 ? void 0 : f.defaultValue;
...
function objectFieldsToUpdateInputFields(fields) {
    return fields.reduce((res, f) => {
        const staticField = f.readonly || (f === null || f === void 0 ? void 0 : f.autogenerate);
        if (staticField) {
            return res;
        }
        const fieldType = f.typeMeta.input.update.pretty;
