...
const EventType_1 = require("../types/enums/EventType");
...
function generateSubscriptionTypes({ schemaComposer, nodes, }) {
    ...
    nodes.forEach((node) => {
        const eventPayload = (0, generate_event_payload_type_1.generateEventPayloadType)(node, schemaComposer);
        ...
        const nodeCreatedEvent = schemaComposer.createObjectTC({
            ...
            fields: {
                event: {
                    ...
                    resolve: () => { var _a; return (_a = EventType_1.EventType.getValue("CREATE")) === null || _a === void 0 ? void 0 : _a.value; },
                },
            },
        });
        const nodeUpdatedEvent = schemaComposer.createObjectTC({
            ...
            fields: {
                event: {
                    type: eventTypeEnum.NonNull,
                    resolve: () => { var _a; return (_a = EventType_1.EventType.getValue("UPDATE")) === null || _a === void 0 ? void 0 : _a.value; },
                },
            },
        });
        const nodeDeletedEvent = schemaComposer.createObjectTC({
            ...
            fields: {
                event: {
                    type: eventTypeEnum.NonNull,
                    resolve: () => { var _a; return (_a = EventType_1.EventType.getValue("DELETE")) === null || _a === void 0 ? void 0 : _a.value; },
                },
            },
        });
